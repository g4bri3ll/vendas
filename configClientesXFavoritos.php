...
<head>
	...
	<title>Configura os favoritos dos clientes</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="alert alert-danger">
                                <span><b> Atenção!!! </b> <p> Essa configuração permitir os clientes a salvarem os lanches como favoritos, para agilizar o atendimento. </p> </span>
                            </div>
                            
                            <?php if (!empty($_SESSION['cadastro'])) { ?>
                                <br /><div class="alert alert-success">
                                    <button type="button" aria-hidden="true" class="close">×</button>
                                    <span><b> Salvo a quantidade de favoritos ao cliente com sucesso !!!! </b></span>
                                </div>
                            <?php } ?>
                            ...
                            <?php if (!empty($_SESSION['erroCadastro'])) { ?>
                                <br /><div class="alert alert-danger">
                                    <button type="button" aria-hidden="true" class="close">×</button>
                                    <span><b> Cliente já possui favoritos adicionado !!!! </b></span>
                                </div>
                            <?php } ?>

                            <div class="header">
                                <h4 class="title">Configurar uma certa quantidade de favoritos ao cliente especifico</h4>
                            </div>
                            <div class="content">
                                <form action="Controller/ControllerFavorito.php" method="POST" >
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Cadastra quantidade de favoritos</button>
