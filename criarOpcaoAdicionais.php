                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <?php if (!empty($_GET['salva'])) { ?>
                                <br /><div class="alert alert-success">
                                    <button type="button" aria-hidden="true" class="close">×</button>
                                    <span><b> Opção adicional cadastrado com sucesso !!!! </b></span>
                                </div>
                            <?php } ?>

                            <div class="header">
                                <h4 class="title">Cadastro de opções adicionais</h4>
                            </div>
                            <div class="content">
                                <form action="Controller/ControllerOpcaoAdicional.php" method="POST">
                                    
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Infome a opção adicionais</label>
                                    ...
                                    <input type="submit" value="Cria opção adicional" class="btn btn-info btn-fill pull-right" />
