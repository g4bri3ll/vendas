...
<head>
	...
	<title>Cadastro de Ingrediente nos lanches</title>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        $arrayItens = $lanDAO->listaLanchesAdd();
        ?>
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <?php if (!empty($_SESSION['cad'])) { ?>
                                <br /><div class="alert alert-success">
                                    <button type="button" aria-hidden="true" class="close">×</button>
                                    <span><b> Ingrediente cadastrado com sucesso !!!! </b></span>
                                </div>
                            <?php } ?>

                            <div class="header">
                                <h4 class="title">Cadastro de ingredientes</h4>
                            </div>
                            <div class="content">
                                <form action="Controller/ControllerIngredientes.php" method="POST">
                                    
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nome do ingrediente</label>
                                                <input type="text" class="form-control" name="nome" placeholder="nome do ingrediente">
                                            </div>
                                        </div>                                        
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Informe qual o lanche</label>
                                                <select class="form-control" name="idLanche">
                                                    <option value="0"> Seleciona o lanche </option>
                                                    <?php foreach ( $arrayItens as $lanDAO => $lanche ) { ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="qtd" placeholder="10" value="1" />
                                            </div>
                                        </div>                                        
                                    </div>

                                    <input type="submit" value="Cadastro de ingredientes" class="btn btn-info btn-fill pull-right" />
