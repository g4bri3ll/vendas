...
<head>
	...
	<title>Cadastrar clientes para fiados</title>
                        ...
                        <div class="card">
                            ...
                            <?php if (!empty($_GET['cad'])) { ?>
                                <br /><div class="alert alert-success">
                                    ...
                                    <span><b> Cliente cadastrado para o fiado com sucesso !!!! </b></span>
                                </div>
                            <?php } ?>

                            <?php 
                                $cliDAO = new ClientesDAO();
                                $array = $cliDAO->ListaClientesParaFiados();
                            ?>

                            <div class="header">
                                <h4 class="title">Cadastrar os clientes para fiados</h4>
                            </div>
                            <div class="content">
                                <form action="Controller/ControllerFiado.php" method="POST" >
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="idCliente">
                                                    ...
                                                    <option value="<?php echo $cliente['id_cliente'] ?>"><?php echo $cliente['nome_pessoa'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Cadastra Fiado</button>
