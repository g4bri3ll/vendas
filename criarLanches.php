...
<head>
	...
	<title>Criação de lanches para a venda</title>
                        ...
                        <div class="card">
                            ...
                            <?php if (!empty($_GET['cad'])) { ?>
                                <br /><div class="alert alert-success">
                                    ...
                                    <span><b> Lanche cadastrado com sucesso !!!! </b></span>
                                </div>
                            <?php } ?>

                            <?php 
                                $forDAO = new FornecedorDAO();
                                $array = $forDAO->ListaFornecedores();
                            ?>

                            <div class="header">
                                <h4 class="title">Criação de lanches</h4>
                            </div>
                            <div class="content">
                                <form action="Controller/ControllerLanche.php" method="POST" enctype="multipart/form-data">
                                    
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nome do lanche</label>
                                                <input type="text" class="form-control" placeholder="nome do lanche" name="nomeProduto"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="codigo de barra do lanche" name="codigoBarra"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="valor" pattern="[0-9]+([,\.][0-9]+)?" step="any" min="0" />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Seleciona Fornecedor</label>
                                                <select class="form-control" name="idForncedor">
                                                    <option value="0"> Nome do forncedor </option>
                                                    <?php foreach ( $array as $forDAO => $forn ) { ?>
                                                    <option value="<?php echo $forn['id_pessoa'] ?>"><?php echo $forn['nome_pessoa'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Criar lanche</button>
