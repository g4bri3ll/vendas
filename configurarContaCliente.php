...
<head>
	...
	<title>Configura a forma de pagamento ao cliente</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="alert alert-danger">
                                <span><b> Atenção! </b> <p> Fazendo dessa forma, você vincula a forma de pagamento ao cliente. Sendo assim, somente os cadastrados farão compra neste método </p> </span>
                            </div>

                            <?php if (!empty($_SESSION['cadastro'])) { ?>
                                <br /><div class="alert alert-success">
                                    <button type="button" aria-hidden="true" class="close">×</button>
                                    <span><b> Cliente vinculado a forma de pagamento cadastrado com sucesso !!!! </b></span>
                                </div>
                            <?php } ?>
                            ...
                            <?php if (!empty($_SESSION['erroCadastro'])) { ?>
                                <br /><div class="alert alert-danger">
                                    <button type="button" aria-hidden="true" class="close">×</button>
                                    <span><b> Cliente já possui o vinculo a forma de pagamento !!!! </b></span>
                                </div>
                            <?php } ?>

                            <div class="header">
                                <h4 class="title">Configurar uma conta, ao método de pagamentos ao cliente especifico</h4>
                            </div>
                            <div class="content">
                                <form action="Controller/ControllerFormaPgto.php" method="POST" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="idCliente">
                                                    ...
                                                    <?php foreach ( $arrayCliente as $cliDAO => $cliente ) { ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="idFormaPgto">
                                                    ...
                                                    <?php foreach ( $arrayPgto as $forDAO => $forn ) { ?>
                                                    <option value="<?php echo $forn['id'] ?>"><?php echo $forn['forma_pgto'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Cadastrar método</button>
